...
const FeaturedProducts = ({type}) => {
  ...
  return (
    <div className='FeaturedProducts'>
        <div className="top">
        <h1>{type} products</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore, provident! Maiores, aliquid eos est in quam quia animi fugiat excepturi asperiores autem beatae accusantium vitae quibusdam. Hic eum incidunt ratione ipsam minima fuga illo.</p>
        </div>
